...
nl_max_len = 30
# seq_max_len = 111
train_num = 55520  # 960 68  69488-55568 copy=69400--55520 1w-8000 1000-800
...
for epoch in range(epoches):
    ...
    if eval_loss < best_test_loss:
        ...
        torch.save(trans_model.state_dict(), '/home2/ns/Ns/NS-Attention/model/save-model/trans_loss1.pt')
...
def predict():
    ...
    trans_model.load_state_dict(torch.load('/home2/ns/Ns/NS-Attention/model/save-model/trans_loss1.pt'))
    ...
    for a, a2, a3, a4, a5, inputs, _, _ in evl_data_loader:   
        ...
        # exit()
            ...
            ''' xin'''
            str1 = " ".join(x1)
            with open('/home2/ns/Ns/NS-Attention/model/data/hyp6w.txt','a',encoding='utf-8') as ff1:
            # with open('/home2/ns/Ns/NS-Attention/model/data/hyp800.txt','a',encoding='utf-8') as ff1:
    ...
    pred1 = []
    '''xin'''
    with open('/home2/ns/Ns/NS-Attention/model/data/hyp6w.txt','r',encoding='utf-8') as ff:
    # with open('/home2/ns/Ns/NS-Attention/model/data/hyp800.txt','r',encoding='utf-8') as ff:
    ...
    #         ff.writelines(z + '\n')
    ref = []
    with open('/home2/ns/Ns/NS-Attention/model/data/ref6w.txt', 'r', encoding='utf-8') as f:    
        lines = f.readlines()
